...
function ($, _, html2canvas, SlideMenu, ImageUploader, ImageLoader, Roulette) {
    ...
    _.extend(Paskamer.prototype, {
        ...
        initScreenshotButton: function() {
            $('#screenshot-button').click(function() {
                html2canvas($('#content-container').get(0), {
                    allowTaint: true,
                    useCORS: true,
        ...
        initConfirmCreateFormButton: function () {
            $('#create-confirm-button').click(_.bind(function () {
                ...
                var listItem = $('<li class="outfit-list-item">' +
                    ...
                    '<span class="item-list-img"><img class="item-list-thumbnail-fb" src="images/fb-button.png"></span>' +
                    '<span class="item-list-img"><img class="item-list-thumbnail-buy" src="images/buy-icon.png"></span>' +
                    '<div class=""></div>' +
                    '</li>');
...
//        initPostToFacebookButton: function(){
//            $('#post-facebook').click(function () {
//                console.log('FB button');
//                FB.init({ appId: '720622998000501', status: true, cookie: true, xfbml: true, oauth: true });
//
//                function postToWall() {
...
//                                    picture: $('.slot-center img').attr('src'),
//                                    caption: 'My new outfit',
//                                    description: 'Check out this new outfit i crated using Marktplaats Paskamer.'
//                                },
//                                function(response) {
